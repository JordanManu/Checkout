...
describe Promotion do
  ...
  it 'adds a discount of 10% off if the total is over £60' do
    ...
    expect(promo.june_promotion(checkout.basket, checkout.total)).to eq 81
  end
  ...
  it 'reduces the price of lavender hearts to 8.50 if 2 or more are added' do
    ...
    expect(promo.june_promotion(checkout.basket, checkout.total)).to eq 36.95
  end
  ...
  it 'adds multiple discounts to the total' do
    ...
    expect(promo.june_promotion(checkout.basket, checkout.total)).to eq 73.605
  end
end
